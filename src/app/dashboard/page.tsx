  ...
  return (
    <div className="flex flex-row items-center justify-center p-4 gap-6">
      <Button 
        ...
        variant="outline" 
        className="w-[150px] h-[80px] flex-shrink-0 flex items-center justify-center rounded-xl border-2 border-primary/20 hover:border-primary/50 transition-all duration-300 group"
      >
        <GlassWater className="h-16 w-16 text-primary/30 group-hover:text-primary/70 transition-colors" />
      </Button>
